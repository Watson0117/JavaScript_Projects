// this creats an object to keep track of values
const Calculator = {
    //this displays 0 on the screen
    Display_Value: '0',
    // this will hold the first operand for any expressions, we set it to null for now
    First_Operand: null,
    //this will check weather or not the second operand has been input
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //if the perform+Calculation object and the function tha matches the
        // operator is exicuted
...
//this function updated the screen with the cntents of Display_Value
...
keys.addEventListener('click', (event) => {
    ...
    //this ensures that AC clar=ers the numbers from the calculator
